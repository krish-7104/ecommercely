    ...
    <div className="flex flex-col items-center justify-center mx-auto md:h-screen bg-gray-900">
      <div className="w-full rounded-lg shadow-xl md:mt-0 sm:max-w-md xl:p-0 bg-gray-100">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 className="font-Montserrat text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl light:text-white">
          ...
          >
            <div>
              <label
                htmlFor="email"
                className="block mb-2 font-Montserrat text-sm font-medium text-gray-900 light:text-white"
              >
                Your email
              </label>
              <input
            ...
            <div className="flex items-center justify-between">
              <a
                href="#"
                className="text-sm font-Montserrat font-medium text-primary-600 hover:underline light:text-primary-500"
              >
                Forgot password?
              </a>
            </div>
