    ...
    <footer className="text-gray-600 body-font">
      <div className="container px-5 py-14 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-60 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left px-5">
          <p className="text-indigo-800 font-bold text-2xl mb-2">ECommercely</p>
          <p className="text-sm font-semibold">Shop Wisely</p>
          <p className="text-sm">
            Premium And Branded Tshirts, Shirts, Jeans And Hoodies
          </p>
        </div>
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-gray-600 hover:text-gray-800">Developer</a>
              </li>
              <li>
