    ...
    <footer className="text-gray-600 body-font bg-gray-900">
      <div className="container px-5 py-14 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-60 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left px-5">
          <p className="font-Montserrat text-emerald-500 font-bold text-2xl mb-2">
            ECommercely
          </p>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="font-Montserrat title-font font-medium text-emerald-700 tracking-widest text-sm mb-3">
              SHOP
            </h2>
            <nav className="list-none mb-10">
              <Link href={"/products?type=tshirts"}>
                <li className="font-Montserrat text-gray-600 hover:text-emerald-300 text-sm cursor-pointer">
                  T Shirts
                </li>
              </Link>
      ...
      <div className="bg-gray-800">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="font-Montserrat text-sm text-center sm:text-left text-emerald-500 tracking-normal">
            © 2022 ECommercely - By{" "}
            <Link
              href="https://krishjotaniya.netlify.app/"
              rel="noopener noreferrer"
              className="text-emerald-600 ml-1 font-Montserrat"
              target="_blank"
            >
              Krish Jotaniya
            </Link>
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            <Link href={"https://github.com/krish-7104/"}>
              <li
                href={"/about"}
                className="text-emerald-300 hover:text-emerald-500 list-none cursor-pointer font-Montserrat"
              >
                <AiFillGithub />
              </li>
            </Link>
            ...
            >
              <li
                href={"/about"}
                className="ml-3 text-emerald-300 hover:text-emerald-500 list-none cursor-pointer font-Montserrat"
              >
                <AiFillLinkedin />
              </li>
            </Link>
